...
### Reflection -
I worked on an e‑portfolio that let me explore Robotic Process Automation. The e‑portfolio helped me see how Robotic Process Automation links to Business Process Management. Robotic Process Automation can take on rule‑based tasks so companies can cut manual work and boost efficiency.. I also learned that Robotic Process Automation can create a cybersecurity risk especially when bots reach sensitive data and critical systems. Business Process Management benefits, from Robotic Process Automation. It must guard against those risks.
